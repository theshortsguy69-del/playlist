...
function closeModal() {
    ...
    var audio = document.getElementById('playlistAudio');

    // 2. Play the audio
    // This will work because it's triggered by the button click
    audio.play().catch(function(error) {
        console.log("Browser blocked play or file not found:", error);
    });

    // 3. Hide your modal (standard logic)
...
const durations = [235, 260, 190, 300, 285,300,340, 269];
const startTimes = [60, 80, 40, 120, 100,30, 50, 90];
...
function applySoftTheme(card) {
  ...
  body.style.background = `linear-gradient(135deg, rgb(${lr},${lg},${lb}) 0%, #77abea 80%)`;
